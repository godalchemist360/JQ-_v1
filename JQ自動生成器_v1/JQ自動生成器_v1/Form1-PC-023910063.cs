...
namespace JQ自動生成器_v1
{
    public partial class Form1 : Form
    {
        ...
        private void checkBox1_CheckedChanged(object sender, EventArgs e)
        {
            ...
            CheckBox[] allCheckboxes = { checkBox1, checkBox2, checkBox3, checkBox4, checkBox5 };

            DisableOtherCheckboxes(selectedCheckbox, allCheckboxes);
        }


        private void DisableOtherCheckboxes(CheckBox selectedCheckbox, CheckBox[] allCheckboxes)
        {
            ...
            /*
            foreach (CheckBox checkbox in allCheckboxes) {
                if (checkbox == selectedCheckbox) checkbox.Enabled = true;
            }*/
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            /*int checkBoxQuantity = 2;
            for (int i = 1; i <= checkBoxQuantity; i++)
            {
